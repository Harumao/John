export default function Page() {
  return (
    <>
      <section
        id="home"
        className="text-center py-10 bg-red-300 border-8"
      >
      ...
      <section
        id="about"
        className="py-10 bg-white text-gray-800 flex justify-center border-8"
      >
        <div className="w-1/2">
      ...
      <section
        id="contact"
        className="py-10 bg-orange-100 text-gray-800 flex justify-center"
      >
        <div className="w-1/2">
          ...
          <a
            ...
            className="inline-block mt-6 py-3 px-6 bg-red-500 text-white font-bold rounded hover:bg-red-200"
            target="_blank"
